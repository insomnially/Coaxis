  ...
  return (
    <>
      ...
      <div className="inforow" ref={ref2}>
        {[ // Здесь список свойств кондиционера
          {
            emoji: '🔋',
            title: 'Высокая Энергоэффективность',
            text: 'Инверторный компрессор A++ с оптимизированным энергопотреблением. Быстрое охлаждение и поддержание заданной температуры, экономия до 40% электроэнергии.',
          },
          {
            emoji: '🌬️',
